...
# Стоит обратить внимание на следующие атрибуты:
...
class TestRoutes(TestCase):
    ...
    def test_detail_page(self):
        # Проверка доступа к отдельной странице.
    ...
    def test_pages_availability(self):
        # Обьеденение теста test_detail_page и def test_home_page.
        # добавляем проверку других страниц.
        ...
        urls = (
            ...
            # никаких позиционных аргументов, поэтому вторым параметром ставим None.
            ('news:home', None),
